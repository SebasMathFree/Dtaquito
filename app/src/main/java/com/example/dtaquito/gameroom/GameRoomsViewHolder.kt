...
//        roomDistrict.text = "Distrito: ${gameRoom.sportSpace?.districtType ?: "Unknown"}"
//        roomDescription.text = "Descripcion: ${gameRoom.sportSpace?.description ?: " No description"}"
//        roomGameMode.text = "Modo de juego: ${gameRoom.sportSpace?.gamemodeType ?: "N/A"}"
//        roomAmount.text = "Costo de ingreso: ${gameRoom.sportSpace?.amount.toString()}"
//        Picasso.get().load(gameRoom.sportSpace?.image).into(imgSportSpace)
//
//    }
//}